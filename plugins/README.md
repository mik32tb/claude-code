...
| [luxury-website-strategy](./luxury-website-strategy/) | Master visual and interaction strategy for premium, conversion-driven luxury websites targeting high-ticket businesses | **Skill:** `luxury-website-strategy` - Auto-invoked for luxury/conversion-focused websites, providing a complete design system with dark luxury palette, glassmorphic elements, motion guidelines, and QA checklist |
